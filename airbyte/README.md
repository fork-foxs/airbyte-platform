تمام، هذا هو **ملف README.md كامل وجاهز** يمكنك نسخه مباشرة وحفظه في مجلد Airbyte لديك.

لتسهيل الاستخدام المباشر، إليك النسخة الجاهزة للاستخدام دون أي تعديلات إضافية:
